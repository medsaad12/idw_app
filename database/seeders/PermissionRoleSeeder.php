...
class PermissionRoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $rh = Role::find(2);
        $rh->givePermissionTo('chat','G-présence','G-entretiens','G-formations','Calcule-salaire','Calcule-assiduité','Calcule-prime','statistique-agent','G-notifications','G-calendrier');
        $ce = Role::find(3);
